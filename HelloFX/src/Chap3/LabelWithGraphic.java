...
public class LabelWithGraphic extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label lb2 = new Label("HEHE", new Circle(50, 50, 25));
        lb2.setContentDisplay(ContentDisplay.TOP);
        lb2.setTextFill(Color.ORANGE);
        // fill the circle with pink color
        ((Circle) lb2.getGraphic()).setStroke(Color.ORANGE);
        ((Circle) lb2.getGraphic()).setFill(Color.PINK);
