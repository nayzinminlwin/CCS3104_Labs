...
public class TicTacToeClientRMI extends Application {
    ...
    protected boolean initializeRMI() throws Exception {
        ...
        if ((marker = ticTacToe.connect((CallBack) callBackControl)) != ' ') {
            ...
            Platform.runLater(() -> lblIdentification.setText("You are player " + marker));
            return true;
        } else {
    ...
    public class Cell extends Pane {
        ...
        public void setToken(char c) {
            ...
            if (token == 'X') {
                ...
                Platform.runLater(() -> getChildren().add(ellipse)); // Add the ellipse to the pane
            }
        }
